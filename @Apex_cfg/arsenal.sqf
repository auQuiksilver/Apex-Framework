...
//=========================================== GET PLAYER ROLE
_class = toLower (typeOf player);
private _role = 'RIFLEMAN';
// MISSILE SOLDIERS
if (_class in [
	'b_soldier_at_f','b_soldier_aa_f','b_soldier_lat_f','b_soldier_lat2_f','b_recon_lat_f','b_t_soldier_aa_f','b_t_soldier_at_f','b_t_soldier_lat_f','b_t_soldier_lat2_f','b_t_recon_lat_f','b_ctrg_soldier_lat2_tna_f','b_ctrg_soldier_lat_tna_f','b_g_soldier_lat_f','b_g_soldier_lat2_f'
]) then {
	_role = 'MISSILE';
};
// AUTORIFLEMAN
if (_class in [
	'b_ctrg_soldier_ar_tna_f','b_g_soldier_ar_f','b_soldier_ar_f','b_t_soldier_ar_f','b_heavygunner_f'
]) then {
	_role = 'AUTORIFLEMAN';
};
// SNIPER
...
// PILOT
if (_class in [
	'b_helipilot_f','b_pilot_f','b_t_helipilot_f','b_t_pilot_f','b_fighter_pilot_f'
]) then {
	_role = 'PILOT';
};
// OFFICER
if (_class in [
	'b_officer_f','b_g_officer_f','b_t_officer_f','b_gen_commander_f'
]) then {
	_role = 'OFFICER';
};
// LEADER
if (_class in [
	'b_ctrg_soldier_tl_tna_f','b_g_soldier_sl_f','b_g_soldier_tl_f','b_soldier_sl_f','b_soldier_tl_f','b_recon_tl_f','b_t_soldier_sl_f','b_t_soldier_tl_f','b_t_recon_tl_f'
]) then {
	_role = 'LEADER';
};
// UAV OPERATOR
if (_class in [
	'b_soldier_uav_f','b_soldier_uav_06_f','b_soldier_uav_06_medical_f','b_t_soldier_uav_f','b_t_soldier_uav_06_f','b_t_soldier_uav_06_medical_f'
]) then {
	_role = 'UAV';
};
	...
	[
		[	// -------------------------------------------------------------- BLACKLIST
			...
			[	// WEAPONS
				...
				'srifle_gm6_ghex_f','srifle_gm6_f','srifle_gm6_camo_f','srifle_lrr_f','srifle_lrr_camo_f','srifle_lrr_tna_f','srifle_gm6_lrps_f','srifle_gm6_sos_f','srifle_gm6_camo_lrps_f','srifle_gm6_camo_sos_f',
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			[	// WEAPONS
				...
				'arifle_mx_khk_f','arifle_mx_f','arifle_mx_sw_black_f','arifle_mx_sw_khk_f','arifle_mx_sw_f','arifle_mxc_black_f','arifle_mxc_khk_f','arifle_mxc_f','arifle_mxm_black_f','arifle_mxm_khk_f',
				'arifle_mxm_f','hgun_pdw2000_f','smg_05_f','srifle_dmr_01_f','arifle_sdar_f','arifle_spar_01_blk_f','arifle_spar_01_khk_f','arifle_spar_01_snd_f',
				'arifle_spar_01_gl_blk_f','arifle_spar_01_gl_khk_f','arifle_spar_01_gl_snd_f','arifle_spar_02_blk_f','arifle_spar_02_khk_f','arifle_spar_02_snd_f','arifle_spar_03_blk_f','arifle_spar_03_khk_f',
				'arifle_spar_03_snd_f','smg_02_f','arifle_trg20_f','arifle_trg21_f','arifle_trg21_gl_f','arifle_arx_blk_f','arifle_arx_hex_f','smg_01_f',
	...
	[
		...
		[	// -------------------------------------------------------------- WHITELIST
			...
			[	// WEAPONS
				...
				'srifle_lrr_camo_lrps_f','srifle_lrr_camo_sos_f','srifle_lrr_tna_lrps_f','srifle_gm6_ghex_lrps_f','srifle_lrr_lrps_f','srifle_lrr_sos_f',
				'smg_01_f','smg_05_f','smg_02_f',
				'hgun_pistol_heavy_02_f','hgun_pdw2000_f','hgun_pistol_heavy_01_f','hgun_acpc2_f','hgun_p07_khk_f','hgun_p07_f','hgun_pistol_01_f','hgun_rook40_f','hgun_pistol_signal_f',
