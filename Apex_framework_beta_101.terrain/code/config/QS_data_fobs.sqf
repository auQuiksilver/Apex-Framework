	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V1_F",[-21.8242,-38.8457,0],0.335386,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V1_F",[-55.9756,-7.23242,0],91.1544,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
			...
			(if (['SG',missionName,FALSE] call (missionNamespace getVariable 'BIS_fnc_inString')) then [{'Trenchfoot'},{'Trenchfoot'}])
		];
	};
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V2_F",[35.1514,2.4668,-0.021553],269.572,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V2_F",[-22.2642,31.5254,3.5],177.886,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V2_F",[-45.9424,4.66016,0.000930786],67.861,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V2_F",[-219.276,-58.9902,0],256.47,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
			...
			(if (['SG',missionName,FALSE] call (missionNamespace getVariable 'BIS_fnc_inString')) then [{'Forlorn Hope'},{'Forlorn Hope'}])						/* Marker text */
		];
	};
	if (_type isEqualTo 2) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V1_F",[-31.5605,5.75391,0.00716972],72.3388,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V1_F",[-12.0469,50.5371,0.0244427],163.718,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
			...
			(if (['SG',missionName,FALSE] call (missionNamespace getVariable 'BIS_fnc_inString')) then [{'Turnbull'},{'Donald'}])
		];
	};
	if (_type isEqualTo 3) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V3_F",[-48.0625,1.20117,-0.0142536],77.6609,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V3_F",[14.0918,-50.8154,0.03018],2.07213,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V3_F",[-1.7207,54.5039,-0.0391369],151.016,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V3_F",[54.5605,28.9541,0.0512562],228.48,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
			...
			(if (['SG',missionName,FALSE] call (missionNamespace getVariable 'BIS_fnc_inString')) then [{'Monash'},{'Alamo'}])
		];
	};
	if (_type isEqualTo 4) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V1_F",[-4.49316,33.8203,0.0137119],229.29,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V1_F",[39.6465,-28.374,0.0311871],277.066,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V1_F",[-26.0044,-57.3574,-0.0230579],5.85555,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
			...
			(if (['SG',missionName,FALSE] call (missionNamespace getVariable 'BIS_fnc_inString')) then [{'Brisbane'},{'Lonestar'}])
		];
	};
	_return;
};
	...
	if (_type isEqualTo 0) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V4_F",[-26.1318,-31.8672,-0.0303345],58.1537,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[90.8896,8.57422,9.15527e-005],239.945,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[79.7266,82.041,0],204.99,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
	...
	if (_type isEqualTo 1) then {
		...
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V4_F",[-18.0889,-37.0229,0.00660706],59.6746,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[44.6123,6.57227,-0.0320129],225.182,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[45.0684,-42.3984,0.102463],295.812,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
	...
	if (_type isEqualTo 2) then {
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V4_F",[-15.5669,-33.9434,0.00520706],345.174,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[-68.1636,-1.48877,-0.0111599],87.8973,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
	...
	if (_type isEqualTo 3) then {
		_return = [
			...
			[
				...
				["Land_Cargo_Patrol_V4_F",[-30.2444,39.0234,-0.00596046],141.352,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[50.4016,-2.73145,0.0336342],222.876,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
				...
				["Land_Cargo_Patrol_V4_F",[7.54028,-55.7119,-0.0726585],2.97452,[],false,true,true,{{(_this select 0) animate _x;} forEach [['hatch_1_rot',1],['hatch_2_rot',1],['hatch_3_rot',1],['hatch_4_rot',1]];(_this select 0);}], 
