...
// FOB stuff
		[
			'a3\ui_f\data\igui\cfg\cursors\iconRepairAt_ca.paa',
			[1,1,1,1],
			(markerPos 'QS_marker_veh_fieldservice_01'),
			0.75,
			0.75,
			0
		],
		[
			'a3\ui_f\data\igui\cfg\cursors\iconRepairAt_ca.paa',
			[1,1,1,1],
			(markerPos 'QS_marker_veh_fieldservice_02'),
			0.75,
			0.75,
			0
		],
		[
			'a3\ui_f\data\igui\cfg\cursors\iconRepairAt_ca.paa',
			[1,1,1,1],
			(markerPos 'QS_marker_veh_fieldservice_03'),
			0.75,
			0.75,
			0
		],
		[
			'a3\ui_f\data\igui\cfg\cursors\iconRepairAt_ca.paa',
			[1,1,1,1],
			(markerPos 'QS_marker_veh_fieldservice_04'),
			0.75,
			0.75,
			0
		],
