...
[
	...
	["Box_IDAP_Equip_F",[1.1167,1.4668,0.0240002],359.998,[],false,false,false,{(_this select 0) setVariable ['QS_interaction_disabled',TRUE,TRUE];(_this select 0);}],
	...
	["C_IDAP_Truck_02_F",[5.73877,1.8125,0.0442343],0.00148999,[],false,false,false,{(_this select 0) lock 2;(_this select 0) enableVehicleCargo FALSE;(_this select 0) enableRopeAttach FALSE;(_this select 0);}],
	...
	["C_IDAP_Van_02_vehicle_F",[9.3125,2.05249,0.0848665],0.000515136,[],false,false,false,{(_this select 0) lock 2;(_this select 0) enableVehicleCargo FALSE;(_this select 0) enableRopeAttach FALSE;(_this select 0);}], 
	...
	["C_IDAP_supplyCrate_F",[16.7422,-2.97461,0.0240006],270.295,[],false,false,false,{(_this select 0) enableVehicleCargo FALSE;(_this select 0) enableRopeAttach FALSE;(_this select 0);}],
