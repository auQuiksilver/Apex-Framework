...
[
	...
	[2,'land_sandbagbarricade_01_half_f',1,{QS_player getUnitTrait 'engineer'}],
	[2,'land_sandbagbarricade_01_f',1,{QS_player getUnitTrait 'engineer'}],
	[2,'land_sandbagbarricade_01_hole_f',1,{QS_player getUnitTrait 'engineer'}],
	...
	[1,'land_slumwall_01_s_2m_f',1,{(QS_player getUnitTrait 'engineer')}],
	[2,'land_slumwall_01_s_4m_f',2,{(QS_player getUnitTrait 'engineer')}],
	[1,'land_pierladder_f',2,{(QS_player getUnitTrait 'engineer')}],
	[1,'land_portablelight_02_single_folded_yellow_f',2,{(QS_player getUnitTrait 'engineer')}]
]