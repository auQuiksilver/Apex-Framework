...
[
	[	// -------------------------------------------------------------- BLACKLIST
		[	// ITEMS
			...
			[	// assigned items
				'integrated_nvg_f','integrated_nvg_ti_0_f','integrated_nvg_ti_1_f'
			],
			[	// headgear
	...
	[	// -------------------------------------------------------------- WHITELIST
		[	// ITEMS
			...
			[	// assigned items
				'nvgogglesb_blk_f','nvgogglesb_grn_f','nvgogglesb_gry_f',		// thermal HMDs/goggles
				'','itemmap','itemcompass','itemwatch','itemradio','itemgps','b_uavterminal',
				'nvgoggles_tna_f','o_nvgoggles_ghex_f','o_nvgoggles_hex_f','o_nvgoggles_urb_f','nvgoggles_opfor','nvgoggles','nvgoggles_indep'
			],
			[	// headgear
				'h_helmeto_vipersp_ghex_f','h_helmeto_vipersp_hex_f', // thermal helmets
			...
			[	// goggles
				...
				'G_Sport_Blackyellow','G_Sport_Greenblack','G_Sport_Checkered','G_Sport_Red','G_Tactical_Black','G_Aviator','G_Lady_Blue','G_Diving','G_B_Diving','G_O_Diving','G_I_Diving',
				'G_Goggles_VR','G_Balaclava_blk','G_Balaclava_oli','G_Balaclava_combat','G_Balaclava_lowprofile','G_Bandanna_blk','G_Bandanna_oli','G_Bandanna_khk','G_Bandanna_tan',
				'G_Bandanna_beast','G_Bandanna_shades','G_Bandanna_sport','G_Bandanna_aviator','G_Shades_Blue','G_Sport_Blackred','G_Tactical_Clear','G_Balaclava_TI_blk_F','G_Balaclava_TI_tna_F',
				'G_Balaclava_TI_G_blk_F','G_Balaclava_TI_G_tna_F','G_Combat_Goggles_tna_F','G_Respirator_white_F','G_Respirator_yellow_F','G_Respirator_blue_F','G_EyeProtectors_F','G_EyeProtectors_Earpiece_F',
				'G_WirelessEarpiece_F'
			],
			[	// attachments
				'optic_nightstalker','optic_tws','optic_tws_mg',	// thermal optics
				...
				'optic_mrd','acc_flashlight_pistol','acc_flashlight_smg_01','optic_yorris'
			]
		],
		[	// MAGAZINES
		...
		[	// BACKPACKS
			...
			'b_assaultpack_sgg','b_assaultpack_tna_f','b_bergen_dgtl_f','b_bergen_hex_f','b_bergen_tna_f','b_carryall_cbr','b_carryall_ghex_f','b_carryall_ocamo','b_carryall_khk',
		...
		[	// WEAPONS
			'','arifle_arx_ghex_f','hgun_pistol_heavy_02_f','launch_b_titan_short_f','arifle_ak12_f','arifle_ak12_gl_f','arifle_akm_f','arifle_aks_f','srifle_dmr_04_f',
			...
			'lmg_zafir_f','launch_nlaw_f','launch_rpg32_f','launch_rpg32_ghex_f','launch_rpg7_f','launch_i_titan_f','launch_o_titan_ghex_f','launch_o_titan_f','launch_b_titan_f','launch_b_titan_tna_f',
			'launch_o_titan_short_f','launch_o_titan_short_ghex_f','launch_i_titan_short_f','launch_b_titan_short_tna_f','hgun_pistol_heavy_01_f','hgun_acpc2_f','hgun_p07_khk_f','hgun_p07_f','hgun_pistol_01_f',
