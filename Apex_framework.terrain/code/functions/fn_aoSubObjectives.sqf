...
if (_type isEqualTo 1) exitWith {
	...
	if (_subType isEqualTo 'RADIOTOWER') then {
		...
		(missionNamespace getVariable 'QS_radioTower') addEventHandler ['Killed',{_this call (missionNamespace getVariable 'QS_fnc_eventRTKilled');}];
