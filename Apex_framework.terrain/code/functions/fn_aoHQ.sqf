...
diag_log localize 'STR_QS_DiagLogs_028';
...
diag_log (format [localize 'STR_QS_DiagLogs_029',_position1]);
...
diag_log (format [localize 'STR_QS_DiagLogs_030',_hqArray find _hqSelect]);
