...
private _text = (format [localize 'STR_QS_Hints_170',ceil((1 - _repair) * 100),ceil((1 - _refuel) * 100),ceil((_totalCount / _totalFullCount) * 100),(_vehicle getVariable ['QS_ST_customDN',_displayName])]);
