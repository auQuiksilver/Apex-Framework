...
if ((_this # 0) isEqualType '') exitWith {
	...
	if (_type isEqualTo 'APS_BLINDSPOT') then {
		params ['','','_projectile'];
		if (!((['mbt_01_base_f','mbt_02_base_f','mbt_03_base_f','mbt_04_base_f','afv_wheeled_01_base_f'] findIf {(_vehicle isKindOf _x)}) isEqualTo -1)) then {
...
if (!((['apc_wheeled_03_base_f','apc_wheeled_02_base_f','apc_wheeled_01_base_f','afv_wheeled_01_base_f'] findIf {(_vehicle isKindOf _x)}) isEqualTo -1)) then {
	// Tier 1
	_list = [
		TRUE,												// QS_aps_enabled
		(_vehicle selectionPosition 'commander_gun'),		// QS_aps_sensorPos
...
if (!((['apc_tracked_01_base_f','apc_tracked_02_base_f','apc_tracked_03_base_f'] findIf {(_vehicle isKindOf _x)}) isEqualTo -1)) then {
	// Tier 2
	_list = [
		TRUE,												// QS_aps_enabled
		(_vehicle selectionPosition 'commander_gun'),		// QS_aps_sensorPos
...
if (!((['mbt_02_base_f','mbt_03_base_f','mbt_01_base_f'] findIf {(_vehicle isKindOf _x)}) isEqualTo -1)) then {
	// Tier 3
	_list = [
		TRUE,												// QS_aps_enabled
		(_vehicle selectionPosition 'commander_gun'),		// QS_aps_sensorPos
...
if (!((['mbt_04_base_f'] findIf {(_vehicle isKindOf _x)}) isEqualTo -1)) then {
	// Tier 4
	_list = [
		TRUE,												// QS_aps_enabled
		(_vehicle selectionPosition 'commander_gun'),		// QS_aps_sensorPos
