...
if (_case isEqualTo -1) exitWith {
	...
	_return = [
		...
		[
			'o_t_mbt_04_command_f',((_tank_modifier * _p_1) * 0.5),
			'o_t_mbt_04_cannon_f',((_tank_modifier * _p_1) * 0.5),
			'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_1,
			'i_mbt_03_cannon_f',_tank_modifier * _p_1,
			'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_1,
			'o_t_apc_tracked_02_cannon_ghex_f',_p_1,
			'i_apc_tracked_03_cannon_f',_p_1,
			'i_lt_01_aa_f',_air_modifier * _p_1,
			'i_lt_01_at_f',_p_1,
			'i_lt_01_cannon_f',_p_1,
			'i_apc_wheeled_03_cannon_f',_p_1,
			'o_t_apc_wheeled_02_rcws_v2_ghex_f',_p_1,
			'o_t_mrap_02_gmg_ghex_f',_p_1,
			'o_t_mrap_02_hmg_ghex_f',_p_1,
			'i_mrap_03_gmg_f',_p_1,
			'i_mrap_03_hmg_f',_p_1,
			'o_t_lsv_02_at_f',_tank_modifier * _p_1,
			'o_t_lsv_02_armed_f',_p_1,
			'o_g_offroad_01_at_f',_tank_modifier * _p_1,
			'o_g_offroad_01_armed_f',_p_1,
			'i_c_offroad_02_at_f',_tank_modifier * _p_1,
			'i_c_offroad_02_lmg_f',_p_1
...
if (_case isEqualTo 0) exitWith {
	...
	_return = [
		...
		[
			...
			'o_t_mbt_04_cannon_f',_tank_modifier * _p_0,
			'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_1,
			'i_mbt_03_cannon_f',_tank_modifier * _p_1,
			'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_1,
			'o_t_apc_tracked_02_cannon_ghex_f',_p_1,
	...
	if (_allPlayersCount > 10) then {
		_return = [
			...
			[
				...
				'i_apc_wheeled_03_cannon_f',_p_1,
				'o_t_apc_wheeled_02_rcws_v2_ghex_f',_p_1,
				'o_t_mrap_02_gmg_ghex_f',_p_2,
				'o_t_mrap_02_hmg_ghex_f',_p_2,
				'i_mrap_03_gmg_f',_p_2,
				'i_mrap_03_hmg_f',_p_2,
				'o_t_lsv_02_at_f',_tank_modifier * _p_2,
				'o_t_lsv_02_armed_f',_p_2,
				'o_g_offroad_01_at_f',_tank_modifier * _p_1,
				'o_g_offroad_01_armed_f',_p_1,
				'i_c_offroad_02_at_f',_tank_modifier * _p_1,
				'i_c_offroad_02_lmg_f',_p_1
	...
	if (_allPlayersCount > 20) then {
		_return = [
			...
			[
				...
				'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_1,
				'i_mbt_03_cannon_f',_tank_modifier * _p_1,
				'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_2,
				'o_t_apc_tracked_02_cannon_ghex_f',_p_2,
				'i_apc_tracked_03_cannon_f',_p_2,
				'i_lt_01_aa_f',_air_modifier * _p_2,
				'i_lt_01_at_f',_p_2,
				'i_lt_01_cannon_f',_p_2,
				'i_apc_wheeled_03_cannon_f',_p_2,
				'o_t_apc_wheeled_02_rcws_v2_ghex_f',_p_2,
				'o_t_mrap_02_gmg_ghex_f',_p_2,
				'o_t_mrap_02_hmg_ghex_f',_p_2,
				'i_mrap_03_gmg_f',_p_1,
				'i_mrap_03_hmg_f',_p_1,
	...
	if (_allPlayersCount > 30) then {
		_return = [
			...
			[
				'o_t_mbt_04_command_f',((_tank_modifier * _p_1) * 0.5),
				'o_t_mbt_04_cannon_f',((_tank_modifier * _p_1) * 0.5),
				'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_2,
				'i_mbt_03_cannon_f',_tank_modifier * _p_2,
				'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_3,
				'o_t_apc_tracked_02_cannon_ghex_f',_p_3,
				'i_apc_tracked_03_cannon_f',_p_3,
				'i_lt_01_aa_f',_air_modifier * _p_3,
				'i_lt_01_at_f',_p_3,
				'i_lt_01_cannon_f',_p_3,
				'i_apc_wheeled_03_cannon_f',_p_3,
				'o_t_apc_wheeled_02_rcws_v2_ghex_f',_p_3,
				'o_t_mrap_02_gmg_ghex_f',_p_1,
				'o_t_mrap_02_hmg_ghex_f',_p_1,
				'i_mrap_03_gmg_f',_p_1,
				'i_mrap_03_hmg_f',_p_1,
	...
	if (_allPlayersCount > 40) then {
		_return = [
			...
			[
				'o_t_mbt_04_command_f',((_tank_modifier * _p_2) * 0.75),
				'o_t_mbt_04_cannon_f',((_tank_modifier * _p_2) * 0.75),
				'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_3,
				'i_mbt_03_cannon_f',_tank_modifier * _p_3,
				'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_3,
				'o_t_apc_tracked_02_cannon_ghex_f',_p_3,
				'i_apc_tracked_03_cannon_f',_p_3,
...
if (_case isEqualTo 3) exitWith {
	_return = [
		...
		[
			'o_t_mbt_04_command_f',((_tank_modifier * _p_1) * 0.75),
			'o_t_mbt_04_cannon_f',((_tank_modifier * _p_1) * 0.75),
			'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_1,
			'i_mbt_03_cannon_f',_tank_modifier * _p_1,
			'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_1,
			'o_t_apc_tracked_02_cannon_ghex_f',_p_1,
	...
	if (_allPlayersCount > 40) then {
		_return = [
			...
			[
				'o_t_mbt_04_command_f',((_tank_modifier * _p_2) * 0.5),
				'o_t_mbt_04_cannon_f',((_tank_modifier * _p_2) * 0.5),
				'o_t_mbt_02_cannon_ghex_f',_tank_modifier * _p_3,
				'i_mbt_03_cannon_f',_tank_modifier * _p_3,
				'o_t_apc_tracked_02_aa_ghex_f',_air_modifier * _p_3,
				'o_t_apc_tracked_02_cannon_ghex_f',_p_3,
...
if (_case isEqualTo 5) exitWith {
	...
	_return = [
		...
		[
			'o_t_mbt_04_command_f',0,
			'o_t_mbt_04_cannon_f',0,
			'o_t_mbt_02_cannon_ghex_f',0.1,
			'i_mbt_03_cannon_f',0.1,
			'o_t_apc_tracked_02_aa_ghex_f',0,
			'o_t_apc_tracked_02_cannon_ghex_f',0.1,
			'i_apc_tracked_03_cannon_f',0.1,
			'i_lt_01_aa_f',1,
			'i_lt_01_at_f',1,
			'i_lt_01_cannon_f',1,
			'i_apc_wheeled_03_cannon_f',0.5,
			'o_t_apc_wheeled_02_rcws_v2_ghex_f',0.5,
			'o_t_mrap_02_gmg_ghex_f',1,
			'o_t_mrap_02_hmg_ghex_f',1,
			'i_mrap_03_gmg_f',1,
			'i_mrap_03_hmg_f',1,
			'o_t_lsv_02_at_f',1,
