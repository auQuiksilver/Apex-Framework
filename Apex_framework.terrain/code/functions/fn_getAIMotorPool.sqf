...
if (_case isEqualTo 0) exitWith {
	...
	if (_allPlayersCount > 30) then {
		_return = [
			[
				'o_mbt_04_command_f',_tank_modifier * _p_2,
				'o_mbt_04_cannon_f',_tank_modifier * _p_2,
			...
			[
				'o_t_mbt_04_command_f',_tank_modifier * _p_2,
				'o_t_mbt_04_cannon_f',_tank_modifier * _p_2,
	...
	if (_allPlayersCount > 40) then {
		_return = [
			[
				'o_mbt_04_command_f',_tank_modifier * _p_2,
				'o_mbt_04_cannon_f',_tank_modifier * _p_3,
			...
			[
				'o_t_mbt_04_command_f',_tank_modifier * _p_2,
				'o_t_mbt_04_cannon_f',_tank_modifier * _p_3,
