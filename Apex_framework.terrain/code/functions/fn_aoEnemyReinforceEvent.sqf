	...
	if (_event isEqualTo 1) exitWith {
		...
		for '_x' from 0 to 2 step 1 do {
			...
			for '_x' from 0 to 49 step 1 do {
				...
				if ((allPlayers inAreaArray [_spawnPos,400,400,0,FALSE]) isEqualTo []) then {
			...
			_v addEventHandler [
				'HandleDamage',
				{
					...
					_olddamage = _gethit # _i;
					_damage = _olddamage + ((_this # 2) - _olddamage) * 0.25;
