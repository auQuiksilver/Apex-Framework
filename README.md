Apex Framework 1.1.4 Dev Build by Quiksilver       ( armacombatgroup@gmail.com ) ( https://www.patreon.com/QS )
...
0. Download the "Apex_framework_114_dev_allFiles.zip" file.
...
class Missions {
  ...
  class apex_framework {
    ...
    template="Apex_framework_114_dev.Altis";

    //template="Apex_framework_114_dev.Tanoa";

    //template="Apex_framework_114_dev.Malden";
...
missionWhitelist[] = {"Apex_framework_114_dev.Altis","Apex_framework_114_dev.Tanoa","Apex_framework_114_dev.Malden"};
```
