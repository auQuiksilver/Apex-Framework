...
Description:
	...
	(_this select 0) setVariable ['QS_curator_disableEditability',TRUE,FALSE];
__________________________________________________________________________/*/

(selectRandom [
	[
		["Land_MedicalTent_01_white_IDAP_open_F",[-0.351563,0.0888672,0],90.433,[],false,true,false,{(_this select 0) setVectorUp [0,0,1];(_this select 0);}], 
		...
		["Box_IDAP_Equip_F",[-2.33887,-2.98926,4.76837e-007],267.614,[],false,true,false,{(_this select 0) setVariable ['QS_interaction_disabled',TRUE,TRUE];(_this select 0) setVariable ['QS_curator_disableEditability',TRUE,FALSE];(_this select 0);}], 
		...
		["Box_IDAP_Uniforms_F",[-4.28809,-2.08643,-4.76837e-007],359.999,[],false,true,false,{(_this select 0) setVariable ['QS_interaction_disabled',TRUE,TRUE];(_this select 0) setVariable ['QS_curator_disableEditability',TRUE,FALSE];(_this select 0);}], 
		...
		["C_IDAP_supplyCrate_F",[-5.49609,8.9165,0],6.0258,[],false,true,false,{(_this select 0) enableRopeAttach FALSE;(_this select 0) enableVehicleCargo FALSE;(_this select 0) setVariable ['QS_curator_disableEditability',TRUE,FALSE]; clearBackpackCargoGlobal (_this select 0);(_this select 0);}], 
