	...
	[
		...
		["Land_Pod_Heli_Transport_04_ammo_F",[1.96533,1.95557,0.0235405],270.37,[],false,true,true,{
			...
			for '_x' from 0 to 2 step 1 do {
				_box setVariable ['QS_sc_subObj_2',TRUE,TRUE];
				_box setVariable ['QS_secured',FALSE,TRUE];
		...
		["Box_T_East_Wps_F",[-0.0299072,-0.923096,0.0239992],0.00329516,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_GEN_Equip_F",[0.325684,-1.98413,0.0239992],359.964,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_Syndicate_Ammo_F",[-1.85022,1.19556,0.0239992],254.757,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_T_NATO_Wps_F",[-1.95532,2.31909,0.0239992],267.494,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_T_East_Ammo_F",[0.290771,-3.12866,0.0239992],338.145,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_Syndicate_WpsLaunch_F",[0.756592,3.74487,0.0240002],0.00161651,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_NATO_Grenades_F",[3.88513,-0.512451,0.0239992],27.8111,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
		["Box_Syndicate_Ammo_F",[3.78589,-1.49121,0.0239992],87.0554,[],false,true,false,{_box = _this select 0;[_box,0,nil] call (missionNamespace getVariable 'QS_fnc_customInventory');_box;}],
